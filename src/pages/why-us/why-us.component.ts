  ...
  benefits: Benefit[] = [
    {
      ...
      description: 'Plus de 10 ans d\'experience dans le recrutement transfrontalier avec une connaissance approfondie des marches europeens.',
      icon: 'M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9',
      color: '#C41E3A'
    },
    {
      title: 'Reseau etendu',
      description: 'Partenaires dans plus de 15 pays nous donnant acces a un vivier de candidats exceptionnel.',
      icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z',
      color: '#2E8B57'
    },
    {
      title: 'Accompagnement complet',
      description: 'De la selection a l\'integration complete, nous gerons tout pour votre tranquillite.',
    ...
    },
    {
      ...
      description: 'Formations linguistiques integrees pour garantir une integration professionnelle reussie.',
      icon: 'M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129',
      color: '#D4AF37'
    },
    {
      title: 'Garantie qualite',
      description: 'Taux de satisfaction de 98% grace a notre selection rigoureuse et notre suivi continu.',
